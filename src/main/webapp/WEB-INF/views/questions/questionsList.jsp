...
<body>
	...
	<div class="container">
		<!-- START : 검색 폼  -->
			...
			<h3>
				문의사항 - <small>Q & A</small>
			</h3>
		</div>
		
				<!-- START : 목록건수 및 새글쓰기 버튼  -->
			<div class="col-sm-3 form-inline" style="margin-bottom: 10px; margin-left: 14px;">
				전체 ${searchVO.totalRowCount } 조회 <select id="id_rowSizePerPage"
					name="rowSizePerPage" class="form-control input-sm" style="margin-left: 8px;">
		...
		<div class="">
			<div class="panel-body">
				<form name="search" action="questionsList.wow" method="post"
					...
					<div class="form-group">
						<label for="id_searchCategory"
							class="col-sm-2 col-sm-offset-2 control-label" style="margin-left: 40px;">분류</label>
						<div class="col-sm-2">
					...
					<label for="id_searchType" class="col-sm-2 control-label" style="margin-left: 40px;">검색</label>
						<div class="col-sm-2">
			...
			<tbody>
				<c:forEach items="${questionsList }" var="questions">
					<tr class="text-center">
						<td>${questions.qNo }</td>
						<td>${questions.qCategoryNm }</td>
						<td class="text-left"><a
							href="questionsView.wow?qNo=${questions.qNo }">
								${questions.qTitle } </a></td>
						<td>${questions.qWriter }</td>
						<td>${questions.qRegDate }</td>
		...
		<div class="row">
			<div class="col-sm-2 col-sm-offset-10 text-right"
				...
				<a href="questionsForm.wow" class="btn btn-primary btn-sm"> <span
		...
		<nav class="text-center">
			<ul class="pagination">
				...
				<!-- 첫 페이지  -->
				<li><a href="questionsList.wow?curPage=1" data-page="1"><span
						aria-hidden="true">&laquo;</span></a></li>

				<!-- 이전 페이지 -->
				<c:if test="${searchVO.firstPage != 1 }">
					<li><a href="questionsList.wow?curPage=${searchVO.firstPage - 1 }"
				...
				<c:forEach begin="${searchVO.firstPage }"
					...
					<c:if test="${searchVO.curPage != i }">
						<li><a href="questionsList.wow?curPage=${i }" data-page="${i }">${i }</a></li>
					</c:if>
					<c:if test="${searchVO.curPage == i }">
				...
				<c:if test="${searchVO.lastPage != searchVO.totalPageCount }">
					<li><a href="questionsList.wow?curPage=${searchVO.lastPage + 1}"
						data-page="${searchVO.lastPage + 1}"><span aria-hidden="true">&gt;</span></a></li>
				</c:if>

				<!-- 마지막 페이지 -->
				<li><a href="questionsList.wow?curPage=${searchVO.totalPageCount }"
