...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h3>
				문의사항 - <small>글 등록</small>
			</h3>
		</div>
		<form:form action="questionsRegist.wow" method="post"
			modelAttribute="questions" enctype="multipart/form-data">
			<table class="table table-striped table-bordered">
				...
				<tr>
					<th>작성자</th>
					<td><form:input path="qWriter"
							cssClass="form-control input-sm" /> <form:errors path="qWriter" />
					</td>
				</tr>
				<tr>
					<th>분류</th>
				...
				<tr>
					...
					<td><form:textarea path="qContent" rows="10"
							cssClass="form-control" /> <form:errors path="qContent" /></td>
				</tr>
				<tr>
					<th>첨부파일
