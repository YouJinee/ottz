	...
	<div class="container">
		...
		<table class="table table-striped table-bordered">
			<tbody>
				...
				<tr>
					<th>내용</th>
					<td><textarea rows="10" name="qContent"
				...
				<tr>
					...
					<tr>
						<th>첨부파일</th>
						<td>
							<c:forEach var="f" items="${questions.attaches}" varStatus="st">
							<div>
								파일 ${st.count} <a
				...
				<tr>
					<td colspan="2">
						...
						<c:if test="${USER_INFO.userNickName == questions.qWriter}">
						<div class="pull-right">
							<a href="questionsEdit.wow?qNo=${questions.qNo }"
		...
		<div class="">
			<div class="form-horizontal">
				<form name="frm_reply" action="<c:url value='/replyRegist' />"
					...
					<input type="hidden" name="reParentNo" value="${questions.qNo}">
					<input type="hidden" name="reCategory" value="QUESTIONS"> <input
...
var params = {"curPage" : 1, "rowSizePerPage" : 5, 
		"reCategory" : "QUESTIONS", "reParentNo" : "${questions.qNo}" 
		};
...
function fn_reply_list() {
	...
	success : function (data) {
		...
		$.each(data.data, function(index, element) {
	        ...
	        + '<div class="col-sm-2 text-center" >'+element.reNickName+'</div>'
